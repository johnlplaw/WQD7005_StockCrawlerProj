...
length _Pformat1 $58;
drop _Pformat1;
_Pformat1 = strip(put(REP_updownInd, $8.));
if
_Pformat1 = 'down'
then do;
if (938+1-_C000003)*_genvalue_ <= (469 - _C000001) then do;
_C000001 + 1;
...
_Pformat1 = 'unchange'
then do;
if (844+1-_C000006)*_genvalue_ <= (422 - _C000004) then do;
_C000004 + 1;
output EMWS3.Part_TRAIN;
end;
else do;
...
_Pformat1 = 'up'
then do;
if (719+1-_C000009)*_genvalue_ <= (360 - _C000007) then do;
_C000007 + 1;
output EMWS3.Part_TRAIN;
end;
else do;
